...
class AdminProductsLocalDataSource {
  AdminProductsLocalDataSource({Database? database}) : _database = database;

  static const _dbName = 'admin_cache.db';
  static const _metaTable = 'admin_products_cache_meta';
  static const _itemsTable = 'admin_products_cache_items';
  ...
  Future<Database> get _instance async {
    ...
    // Ensure tables exist even when migration callbacks are skipped
    // because of a previously opened database handle.
  ...
  Future<AdminPageResult?> getCachedProducts(String cacheKey) async {
    final db = await _instance;
